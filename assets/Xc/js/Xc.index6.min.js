document.addEventListener("DOMContentLoaded", () => {
  ...
  const generateArticleHTML = article => {
    const {
      permalink, title, type, abstract,
      created, views, commentsNum, agree,
      category
    } = article;
  ...
  const resetArticleList = () => {
    const $articleList = $(".Xc_home_article .Xc_home_article-list");
    ...
    return new Promise((resolve, reject) => {
      ...
      $.ajax({
        ...
        success({ data }) {
          ...
          data.forEach(article => $articleList.append(generateArticleHTML(article)));
