...
const e = (e) =>
"default" === e.mode
? `\n<li class="Xc_home_article-si default">\n<a href="${
e.permalink
...
: "single" === e.mode
? `\n<li class="Xc_home_article-si single">\n<div class="information">\n<a href="${
e.permalink
}"class="title"title="${
e.title
}"rel="noopener noreferrer">\n<span class="badge"style="display:${
...
: "multiple" === e.mode
? `\n<li class="Xc_home_article-si multiple">\n<div class="information">\n<a href="${
e.permalink
}"class="title"title="${
e.title
}"rel="noopener noreferrer">\n<span class="badge"style="display:${
...
e.abstract
}</a>\n</div>\n<a href="${e.permalink}"class="thumbnail"title="${
e.title
}"rel="noopener noreferrer">\n ${e.image
.map((l, t) => {
if (t < 3)
return `<img width="100%"height="100%"class="lazyload"src="${e.lazyload}"data-src="${l}"alt="${e.title}"/>`;
})
.join(
""
)}\n</a>\n<div class="meta">\n<ul class="items">\n<li><svg class="icon2"aria-hidden="true"><use xlink:href="#icon-time"></use></svg>${
...
: `\n<li class="Xc_home_article-si none">\n<div class="information">\n<a href="${
e.permalink
}"class="title"title="${
e.title
}"rel="noopener noreferrer">\n<span class="badge"style="display:${
